...
Create a fetchMovies() function that will make a dynamic API call to what we need 
========================================
...
These are the 3 main functions we must create 
========================================
...
** These functions will provide the URL we need to fetch movies of that genere **

These are all the DIV ID's we're gonna need access to 
========================================================
